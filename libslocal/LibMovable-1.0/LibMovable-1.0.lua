...
do
	...
	libPath = "\\Interface\\AddOns\\MonkTimers\\libs\\LibMovable-1.0.lua\\"
	if libPath then
...
function lib.SpawnOverlay(data)
	...
	local overlay = setmetatable(CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate"), lib.meta)
